...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
void LPUART1_Transmit(char message[])
{
int message_lengh=strlen(message);
int i=0;
for(i=0;i<message_lengh;i++)
	{
	LL_LPUART_TransmitData8(LPUART1,message[i]);
...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
   LPUART1_Transmit("void LPUART1_Transmit(char message[])\n{\nint message_lengh=strlen(message);\nint i=0;\nfor(i=0;i<message_lengh;i++)\n{\nLL_LPUART_TransmitData8(LPUART1,message[i]);\nwhile(!LL_LPUART_IsActiveFlag_TXE(LPUART1));\n}\n}\n");
	 LL_mDelay(500);
    /* USER CODE BEGIN 3 */
  }
  /* USER CODE END 3 */
